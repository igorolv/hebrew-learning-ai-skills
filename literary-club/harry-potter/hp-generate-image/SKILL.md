...
Формат использования иллюстрации:
...
Важно: итоговая иллюстрация **будет вставляться** в верхнюю часть вертикальной страницы,  
но сам промт **не должен заставлять генератор рисовать полноценную вертикальную A4-страницу целиком**.
...
Иллюстрация предназначена **для размещения над текстом** в верхней части страницы.

Поэтому композиция должна учитывать:

- иллюстрация строится как **wide horizontal book illustration**
- композиция должна быть **landscape**, а не высокой вертикальной постерной
- изображение должно хорошо работать при вставке **в верхнюю часть вертикальной страницы**, с текстом ниже

Запрещено:

- строить композицию как full-page vertical illustration
...
Wide horizontal book illustration, intended for placement above text on a vertical book page.

Landscape composition.
Do not create a tall full-page composition.
The composition must work well when inserted at the top of a page, with body text placed below.
