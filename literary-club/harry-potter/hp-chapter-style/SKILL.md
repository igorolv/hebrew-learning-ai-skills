...
Найди `master_style_framework.md` в Project Knowledge (через `project_knowledge_search`).
Это неизменяемый каркас проекта (секции I–III, V–VI, VIII).
Все решения в chapter style должны быть совместимы с этим каркасом.

> **Если файл не найден** — сообщи пользователю и предложи запустить
> скилл **hp-master-style** с командой `create` для генерации каркаса из шаблона.
