...
- [ ] Огласовки взяты только из реально видимых на странице — ни одна не выдумана
- [ ] Сюжет ГП нигде не использован как источник слов: каждое слово либо видно, либо помечено `без опоры`
