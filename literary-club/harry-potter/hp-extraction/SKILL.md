...
Файлы `.txt` **ненадёжны для ивритского текста**: буквы могут идти в обратном порядке (RTL→LTR), огласовки (никуд) искажены или потеряны, пробелы разрывают слова.

**Основной источник — всегда изображение (`N.png` / `N.jpeg`).** 
...
1. **Открыть изображение `N.png`** (или `N.jpeg`) — это главный источник
