...
- `hebrew-homework-docx` — конвертация выполненного задания в DOCX
...
PPTX урока
   → hebrew-lesson-extract
   → hebrew-lesson-enrich
   ├→ hebrew-homework-solve → hebrew-homework-docx   (ДЗ)
...
Для локального bootstrap-сценария см. [LOCAL_SETUP_AGENT.md](LOCAL_SETUP_AGENT.md) — это инструкция для AI-агента, который должен проверить окружение, установить доступные зависимости и аккуратно запросить ручные шаги только там, где они действительно нужны.
